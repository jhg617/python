...
var1 = ar2[3] # ar2의 3번지에 있는 3.3값이 var1에 저장
...
print("icecream1의 길이:{},{}".format(len(icecream1), icecream1)) # 중복된 값은 제거됨

# icecream1안에 "쿠키앤크림"이라는 정보가 있는지? 확인하자!
res = "쿠키앤크림" in icecream1
print("쿠키앤크림 in icecream1:", res) # False
print("\"쿠키앤크림\" in icecream1:", res) # 쌍따옴표 출력
